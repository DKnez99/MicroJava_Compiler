...
public class ConstListMany extends ConstAssignList {

    private ConstAssignList ConstAssignList;
    private ConstAssign ConstAssign;

    public ConstListMany (ConstAssignList ConstAssignList, ConstAssign ConstAssign) {

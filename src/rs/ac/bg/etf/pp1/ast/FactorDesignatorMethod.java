...
public class FactorDesignatorMethod extends Factor {

    private Designator Designator;
    private ActParsOptional ActParsOptional;

    public FactorDesignatorMethod (Designator Designator, ActParsOptional ActParsOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignatorMethod(\n");
